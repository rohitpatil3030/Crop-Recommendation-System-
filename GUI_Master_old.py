...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='D:/23 Protech/100% code/worm detection and Soil anaylsis/23CP143-Worm+Crop classification/main dataset', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
